                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            infoItem(l!.order_date, DateUtilsHelper.formatYMD(DateTime.parse(provider.salesOrderHeader?.salesOrderDate ?? ''))),
                            ...
                            infoItem(l.order_address, provider.salesOrderHeader?.customerAddress ?? 'Menuggu Ega'),
                          ],
                        ),
                      ),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (widget.isShippingOrder == false) infoItem(l.customerDetail_shippingID, 'Menunggu Ega'),
                            infoItem(l.order_area, provider.salesOrderHeader?.areaAreaName ?? ''),
                            infoItem(l.order_remark, provider.salesOrderHeader?.notes ?? 'Menuggu Ega'),
                          ],
                        ),
                      ),
                    ],
                                    ...
                                    if (int.parse(item.discValue ?? '0') > 0)
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            CurrencyFormat.toRupiah(item.discValue),
                                            style: AppTextStyles.caption1SemiBold.copyWith(color: AppColors.textPrimary),
                                          ),
                                        ],
                                      ),
