...
class SalesReturnOfflinePage extends StatefulWidget {
  const SalesReturnOfflinePage({super.key});

  @override
  State<SalesReturnOfflinePage> createState() => _SalesReturnOfflinePageState();
}

class _SalesReturnOfflinePageState extends State<SalesReturnOfflinePage> {
  final dao = SalesReturnDao();
  ...
  Future<void> loadData() async {
    final result = await dao.getPendingSalesReturn();
    setState(() {
      sales = result;
      isLoading = false;
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Sales Return Offline"),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _row("Sales Date", row['sales_return_date']),
