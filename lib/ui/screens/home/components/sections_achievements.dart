...
import 'package:sail_in_co/ui/widgets/app_pdf_viewer_page.dart';
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: AppButton(
                      ...
                      isLoading: homeProvider.isLoadingSettlement,
                      height: 38,
                      label: l?.home_settlement ?? '',
                      onPressed: () {
                        homeProvider.getSettlement(context).then((_) {
                          if (homeProvider.pathPdf.isNotEmpty) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => AppPdfViewerPage(pdfUrl: homeProvider.pathPdf, title: l?.home_settlement ?? 'Settlement'),
                              ),
                            );
                          }
                        });
