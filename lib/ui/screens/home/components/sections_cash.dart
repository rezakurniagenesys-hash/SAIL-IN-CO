...
import 'package:sail_in_co/ui/screens/history_uangkas/history_uangkas_screen.dart';
...
class SectionsCashDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => HistoryUangkasScreen()));
      },
      child: Padding(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text('Uang Kas', style: AppTextStyles.heading6Bold),
              Center(
                child: Text(
                  'Rp 12,000,000.00',
